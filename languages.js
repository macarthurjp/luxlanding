...
const translations = {
  en: {
    ...
    "referral.eyebrow": "Your reference code",
    "referral.title": "Save this code",
    "referral.instructions": "Mention this code when you contact our partner — it helps them, and us, confirm the connection came through LuxLanding.",
    "referral.copy": "Copy code",
    "referral.copied": "Copied!",
    "referral.continue": "Continue to partner site",
  ...
  fr: {
    ...
    "referral.eyebrow": "Votre code de référence",
    "referral.title": "Enregistrez ce code",
    "referral.instructions": "Mentionnez ce code lorsque vous contactez notre partenaire — cela nous aide, ainsi que le partenaire, à confirmer que la mise en relation vient de LuxLanding.",
    "referral.copy": "Copier le code",
    "referral.copied": "Copié !",
    "referral.continue": "Continuer vers le site du partenaire",
  ...
  es: {
    ...
    "partners.eyebrow": "Partners",
    "partners.title": "Nuestros partners de confianza",
    "partners.loading": "Cargando partners…",

    "referral.eyebrow": "Tu código de referencia",
    "referral.title": "Guarda este código",
    "referral.instructions": "Menciona este código cuando contactes a nuestro partner — nos ayuda, a ellos y a nosotros, a confirmar que la conexión vino de LuxLanding.",
    "referral.copy": "Copiar código",
    "referral.copied": "¡Copiado!",
    "referral.continue": "Continuar al sitio del partner",
  ...
  pt: {
    ...
    "partners.title": "Os nossos parceiros de confiança",
    "partners.loading": "A carregar parceiros…",

    "referral.eyebrow": "O seu código de referência",
    "referral.title": "Guarde este código",
    "referral.instructions": "Mencione este código ao contactar o nosso parceiro — ajuda-nos, a eles e a nós, a confirmar que a ligação veio da LuxLanding.",
    "referral.copy": "Copiar código",
    "referral.copied": "Copiado!",
    "referral.continue": "Continuar para o site do parceiro",
